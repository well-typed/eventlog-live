...
cabal build jumpy-jump --builddir=dist-newstyle/jumpy-jump-with-ghc-stack-profiler -f+use-ghc-stack-profiler -v0
JUMPY_JUMP_BIN=$(cabal list-bin exe:jumpy-jump --builddir=dist-newstyle/jumpy-jump-with-ghc-stack-profiler -f+use-ghc-stack-profiler -v0 | head -n1)
